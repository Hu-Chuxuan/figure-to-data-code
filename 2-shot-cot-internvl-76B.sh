...
python Predictor.py --root ../figure-to-data --output ../output/InternVL2-76B-2-Shot-COT --model OpenGVLab/InternVL2-Llama3-76B --Prompt cot --shot 2 --paper_list $paper_list
EOL
